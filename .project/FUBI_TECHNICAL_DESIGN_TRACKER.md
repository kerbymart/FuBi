...
- [x] M7-04 Add persistent module sessions through the shared command service. ([PR #76](https://github.com/kerbymart/FuBi/pull/76), [PR #114](https://github.com/kerbymart/FuBi/pull/114))
- [x] M7-05 Represent pointer results with opaque IDs rather than lossy JSON
  numbers, and validate same-session pointer reuse. Explicit handle reuse remains in [issue #118](https://github.com/kerbymart/FuBi/issues/118). ([PR #113](https://github.com/kerbymart/FuBi/pull/113), [PR #114](https://github.com/kerbymart/FuBi/pull/114))
...
- [x] M7-09 Pass multi-call session, opaque-reference reuse/release/isolation,
  stdout/stderr, and protocol-negotiation tests. ([PR #76](https://github.com/kerbymart/FuBi/pull/76), [PR #113](https://github.com/kerbymart/FuBi/pull/113), [PR #114](https://github.com/kerbymart/FuBi/pull/114))
